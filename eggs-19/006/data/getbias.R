...
bias <- function(t) {
  ...
  image(x, y, mat, xlab="phi", ylab="psi", zlim=c(0,25), col=rainbow(70)[50:1], axes=F, main="", lwd=2)
  contour(x, y, mat, xlab="phi", ylab="psi", zlim=c(0,25), nlevels=5, add=T, main="", lwd=2)
...
png("bias%03d.png", width=960, height=960, pointsize=24)
for(i in 1:501) {
  bias(i)
}
dev.off()
